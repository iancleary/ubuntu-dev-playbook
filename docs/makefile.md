...
python packages per the [requirements-ansible.txt](https://github.com/iancleary/ansible-desktop/blob/master/requirements-ansible.txt) file.

> This includes Ansible, using Python3.

This also moves the [home-local-bin.sh](https://github.com/iancleary/ansible-desktop/blob/master/home-local-bin.sh)
