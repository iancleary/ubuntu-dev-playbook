...
- Yadm dotfiles repo and branch vars, per [#215](https://github.com/iancleary/linux-dev-playbook/issues/215)
...
- `hey-mail` snap per [#222](https://github.com/iancleary/linux-dev-playbook/issues/222)
- `setup_inventory_and_group_vars` script and `.inventory` in favor of `all` hosts and single `default.config.yml` file.
- library/json_mod ansible module, which was only used in the deprecated ticktick nativefier app [#235](https://github.com/iancleary/linux-dev-playbook/issues/235)
...
- Hyper-V resolution fix, per [#212](https://github.com/iancleary/linux-dev-playbook/issues/212)
...
- [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher), see the [Integrate any AppImage into the Ubuntu Desktop](https://dev.to/strotgen/integrate-tinkerwell-or-any-appimage-into-the-ubuntu-desktop-le9) article. ([#176](https://github.com/iancleary/linux-dev-playbook/issues/176))
- [ULauncher](https://github.com/ULauncher/ULauncher) ([#179](https://github.com/iancleary/linux-dev-playbook/issues/179))
- [Caffeine](https://launchpad.net/caffeine) ([#178](https://github.com/iancleary/linux-dev-playbook/issues/178))
- [PDFSlicer](https://github.com/junrrein/pdfslicer) ([#182](https://github.com/iancleary/linux-dev-playbook/issues/182))

### Changed

- Fixed regression on timeshift package name
- Flameshot moved from deb to snap, per ([#183](https://github.com/iancleary/linux-dev-playbook/issues/183))
...
- updated Makefile to have persistent PATH to resolve [#164](https://github.com/iancleary/linux-dev-playbook/issues/164), thanks for the help [ieguiguren](https://github.com/ieguiguren).
...
- `zsh_default_shell_command` and `zsh_custom_default_shell_command` per [#134](https://github.com/iancleary/linux-dev-playbook/pull/134)
- `python-is-python3` apt package for Python-poetry on Ubuntu 20.04 per [#135](https://github.com/iancleary/linux-dev-playbook/issues/135)
- `dconf` variables and loops per [#131](https://github.com/iancleary/linux-dev-playbook/issues/131)
- `antibody` shell plugin manager per [#132](https://github.com/iancleary/linux-dev-playbook/issues/132)

### Changed

- `zsh_plugins` to drop `ansible` and `aws`; add `yarn`
- Snap variables to include `channel`, `classic`, and `name` dictionary items per [#137](https://github.com/iancleary/linux-dev-playbook/issues/137)
- Moved group_vars from `group_vars/all.yml` to `group_vars/all/*.yml` per [#139](https://github.com/iancleary/linux-dev-playbook/issues/139)
...
- Code Extensions variables per [#83](https://github.com/iancleary/linux-dev-playbook/issues/83)
- Snaps variables
- Added pre-commit python package per [#116](https://github.com/iancleary/linux-dev-playbook/issues/116)
...
- Removed [Archive](https://github.com/iancleary/linux-dev-playbook/blob/4ed8084cbcf95928239effc0f2cb74b7c47d4170/archive/not-used/) folder
...
[Unreleased]: https://github.com/iancleary/linux-dev-playbook/compare/v21.04.1...HEAD
[21.04.1]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v21.04.1
[21.04.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v21.04.0
[2020.1.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v2020.1.0
[0.11.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.11.0
[0.10.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.10.0
[0.9.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.9.0
[0.8.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.8.0
[0.7.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.7.0
[0.6.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.6.0
[0.5.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.5.0
[0.4.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.4.0
[0.3.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.3.0
[0.2.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.2.0
[0.1.1]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.1.1
[0.1.0]: https://github.com/iancleary/linux-dev-playbook/releases/tag/v0.1.0
